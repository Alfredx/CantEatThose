 ...
 *
 */
public abstract class VerticalGalleryAbsSpinner extends
		VerticalGalleryAdapterView<SpinnerAdapter> {
	...
	public VerticalGalleryAbsSpinner(Context context) {
		super(context);
		initAbsSpinner();
	}
	...
	public VerticalGalleryAbsSpinner(Context context, AttributeSet attrs,
		...
		// com.android.internal.R.styleable.VerticalGalleryAbsSpinner, defStyle,
		// 0);
		//
	 ...
	 * It also provides methods to transform spinner items based on their
	 * position
	...
	void recycleAllViews() {
		...
		final VerticalGalleryAbsSpinner.RecycleBin recycleBin = mRecycler;
